...
class TestCouponSystem(TestCase):
    def setUp(self):
        ...
        from now_lms.db import Curso, Usuario, Coupon
    ...
    def test_coupon_validation_functions(self):
        ...
        with self.app.app_context():
            ...
            coupon, error1, error2 = _validate_coupon_for_enrollment(
                paid_course.codigo, "VALID50", student
            )
            ...
            coupon, error1, error2 = _validate_coupon_for_enrollment(
                paid_course.codigo, "INVALID", student
            )
