...
def test_evaluation_models():
    ...
    from now_lms.db import database, Evaluation, Question, QuestionOption, EvaluationAttempt, Answer, EvaluationReopenRequest
    ...
    with lms_app.app_context():
        ...
        reopen_request = EvaluationReopenRequest(
            user_id="test_user",
            evaluation_id="test_eval",
            justification_text="Need another attempt"
        )
...
def test_evaluation_views():
    ...
    from now_lms.vistas.evaluations import take_evaluation, evaluation_result, request_reopen
...
def test_app_integration():
    ...
    with lms_app.app_context():
        ...
        expected_tables = ['evaluation', 'question', 'question_option', 'evaluation_attempt', 'answer', 'evaluation_reopen_request']
